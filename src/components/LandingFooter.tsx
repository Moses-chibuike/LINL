        ...
        <footer className={classes.footer}>
            ...
            <Container className={classes.afterFooter} size="lg">
                ...
                <Group spacing={0} className={classes.social} position="right" noWrap>
                    ...
                    <ActionIcon size="lg" component="a" href="https://www.facebook.com/" target="_blank">
                        <IconBrandFacebook size="20" stroke={2}/>
                    </ActionIcon>
                    <ActionIcon size="lg" component="a" href="https://www.instagram.com/" target="_blank">
                        <IconBrandInstagram size="20" stroke={2}/>
                    </ActionIcon>
                    <ActionIcon size="lg" component="a" href="https://www.linkedin.com/" target="_blank">
